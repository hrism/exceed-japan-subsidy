...
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/css/cese/manufacturing.css">
<body>
<script type="text/javascript" charset="utf-8" src="https://kenga.tech/heatmaps-lamskgxjhjynjgji.js"></script>
<?php
...
?>
  ...
  <section>
    <h1>
      <picture>
        <source media="(max-width:850px)" srcset="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/fv-sp.webp" type="image/webp">
        <img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/fv.webp" alt="製造業向け補助金&助成金で店舗運営をもっとラクに！" width="1200" height="600">
      </picture>
    </h1>
  </section>
		<div class="recruit_bgimg">
			<div class="manufacturing-section-wrap">
  <section class="section-manufacturingcese fade-in-section">
    <h2><span class="under-line_yellow sec1-3point">初めて<span class="section-manufacturingcese_low">の<br
            class="br-sp"></span>補助金申請<span class="section-manufacturingcese_low">でも</span>安心！</span></h2>
    <div>
      <ul class="section-manufacturingcese_flex">
        <li class="section-manufacturingcese_list">
          <div class="section-manufacturingcese_listflex-sp">
            <div class="section-manufacturingcese_list-img"><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/section1-1.webp" alt="製造機械など機器の導入費用">
            </div>
            <p class="section-manufacturingcese_list-title">製造機械など<br>機器の導入費用</p>
          </div>
          <div class="section-manufacturingcese_list-txtbox">
            <p class="section-manufacturingcese_list-txt1">約3,000万円</p>
            <p class="section-manufacturingcese_list-txt2"><span class="under-line_blue">約<span
                  class="section-manufacturingcese_list-txt2-high fonts_oswald">1,500</span>万円で購入!</span></p>
          </div>
        </li>
        <li class="section-manufacturingcese_list">
          <div class="section-manufacturingcese_listflex-sp">
            <div class="section-manufacturingcese_list-img"><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/section1-2.webp" alt="施設、設備の修繕費"></div>
			  <p class="section-manufacturingcese_list-title">建物改装費</p>
          </div>
          <div class="section-manufacturingcese_list-txtbox">
            <p class="section-manufacturingcese_list-txt1">約300万円</p>
            <p class="section-manufacturingcese_list-txt2"><span class="under-line_blue">約<span
                  class="section-manufacturingcese_list-txt2-high fonts_oswald">250</span>万円で対応!</span></p>
          </div>
        </li>
        <li class="section-manufacturingcese_list">
          <div class="section-manufacturingcese_listflex-sp">
            <div class="section-manufacturingcese_list-img"><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/section1-3.webp" alt="システム構築費">
            </div>
            <p class="section-manufacturingcese_list-title">システム構築費</p>
          </div>
          <div class="section-manufacturingcese_list-txtbox">
            <p class="section-manufacturingcese_list-txt1">約1,000万円</p>
            <p class="section-manufacturingcese_list-txt2"><span class="under-line_blue">約<span
                  class="section-manufacturingcese_list-txt2-high fonts_oswald">500</span>万円で運用!</span></p>
          </div>
        </li>
      </ul>
    </div>
...
<section id="case-form" class="section-form fade-in-section">
    <h2><span>あなたの会社で</span><br>補助金が申請できるか確認！</h2>
    <div class="section-form-cont">
        ...
        <div class="option-list active">
            ...
            <ul class="section-form-btn-flex">
                <li class="section-form-btn">
                    <a href="javascript:void(0);" class="set-option" data-option="設備投資、機械購入したい">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/form-btn-1.webp" alt="設備投資、機械購入したい" width="299" height="151">
                        <span>設備投資、<br class="br-sp">機械購入したい</span>
                    </a>
                </li>
                <li class="section-form-btn">
                    <a href="javascript:void(0);" class="set-option" data-option="新規事業や新商材を開発したい">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/form-btn-2.webp" alt="新規事業や新商材を開発したい" width="228" height="167">
                        <span>新規事業や新商材を開発したい</span>
                    </a>
                </li>
				                <li class="section-form-btn">
                    <a href="javascript:void(0);" class="set-option" data-option="省エネ設備の切替などコスト削減したい">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/form-btn-3.webp" alt="省エネ設備の切替などコスト削減したい" width="217" height="155">
                        <span>省エネ設備の<br class="br-sp">切替など<br class="br-sp">コスト削減したい</span>
                    </a>
                </li>
                <li class="section-form-btn">
                    <a href="javascript:void(0);" class="set-option" data-option="補助金以外のサポートも相談したい">
                        <img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/form-btn-4.webp" alt="補助金以外のサポートも相談したい" width="217" height="155">
        ...
        <div class="form-content">
            <?php echo do_shortcode('[contact-form-7 id="37389d9" title="無料相談受付(製造業界)"]'); ?>
        </div>
    </div>
</section>
				
  <section class="section-cva fade-in-section">
    <h2><span>貴社</span>に<span>ぴったり</span>の<br class="br-sp"><span>補助金</span>を<span>ご提案します</span></h2>
    <div class="section-cva-flex">
      ...
      <div class="section-cva-btn-form"><a href="#case-form"><img src="<?php echo get_template_directory_uri(); ?>/images/case/cva-btn-form.webp" alt="フォームから問合せ"
		...
		<!-- カルーセル追加 -->
		<section class="section-manufacturing-carousel">
		<h2>【製造業】補助金導入サポート事例</h2>
...
<!-- 	//カルーセル追加ここまで	 -->
      ...
      <ol>
        <li class="section-recommend-point_list">
          <div class="section-recommend-point_flex">
            <div><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/point-1.webp" alt="スタッフの7割が女性、製造業界との相性◎で採択率91%を実現" width="339" height="225">
            </div>
        ...
        <li class="section-recommend-point_list">
          <div class="section-recommend-point_flex">
            <div><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/point-2.webp" alt="着手金、成功報酬のみで交付申請から実績報告まで対応可能" width="339" height="225"></div>
            <div class="section-recommend-txtbox">
              <p class="section-recommend-txtbox-title">採択率91%を実現<br>専門スタッフにお任せください</p>
              <p class="section-recommend-txtbox-txt">製造業の補助金導入に強い専門スタッフが、91%もの高い採択率を獲得（※2023年度実績）。投資額を問わずご相談ください。</p>
            </div>
          </div>
        </li>
        <li class="section-recommend-point_list">
          <div class="section-recommend-point_flex">
            <div><img src="<?php echo get_template_directory_uri(); ?>/images/case/manufacturing/point-3.webp" alt="数多くの実績をもとに補助金以外のご相談にも 適切にアドバイスします" width="339" height="225">
            </div>
            <div class="section-recommend-txtbox">
  ...
  <section class="section-recommend fade-in-section">
    <h2 class="section-recommend_title"><span class="under-line_yellow">製造業におすすめの補助金</span></h2>
    <div>
      <ul class="section-recommend_flex">
        <li class="section-recommend_cont">
          <div class="section-recommend_cont_box">
            ...
            <p class="section-recommend_cont-txt">設備機器の導入、工場の改修費、広告宣伝費などに活用できます。</p>
          </div>
        </li>
        <li class="section-recommend_cont">
          <div class="section-recommend_cont_box">
            ...
            <p class="section-recommend_cont-why"><span></span>どんな補助金？</p>
            <p class="section-recommend_cont-txt"> 新しい設備機器の導入、高度な技術導入などを支援する補助金です。</p>
          </div>
        </li>
        <li class="section-recommend_cont">
          <div class="section-recommend_cont_box">
    ...
    <ul class="faq-container">
      <li class="faq-item">
        <div class="faq-header">
          <div class="faq-question"><span class="faq-q-btn"></span>補助金や助成金はどんな製造業者でも申請できますか？</div>
          <button class="toggle-btn">＋</button>
        </div>
        <div class="faq-answer"><span class="faq-a-btn"></span>
        はい、多くの補助金や助成金は中小企業や個人事業主を対象としています。<br>ただし、補助金ごとに業種や従業員数、売上規模などの条件があります。<br>食料品製造業、自動車メーカー、医療品メーカーなど、さまざまな業態に適用できるものもありますので、詳細は各補助金の要項をご確認ください。
        </div>
      </li>
...
<script src="./js/case/js-manufacturing.js"></script>
