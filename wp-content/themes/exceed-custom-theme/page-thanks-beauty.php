...
?>
 ...
 <div id="thanks-beauty-cva" class="contact_wrap">
		<div>
  ...
  <section class="section-cva fade-in-section">
    ...
    <div class="section-cva-flex">
      ...
      <div class="section-cva-btn-form"><a href="#thanks-beauty-cva"><img src="<?php echo get_template_directory_uri(); ?>/images/case/cva-btn-form.webp" alt="フォームから問合せ"
            width="355" height="90"></a></div>
    </div>
  </section>
		<!-- カルーセル追加 -->
